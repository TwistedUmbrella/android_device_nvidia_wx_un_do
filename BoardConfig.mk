...
-include vendor/nvidia/wx_un_do/BoardConfigVendor.mk
...
# Recovery
TARGET_RECOVERY_INITRC := device/nvidia/wx_un_do/init.rc
TARGET_RECOVERY_FSTAB := device/nvidia/wx_un_do/recovery.fstab
...
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/nvidia/wx_un_do/recovery_keys.c
#BOARD_CUSTOM_GRAPHICS := ../../../device/nvidia/wx_un_do/graphics.c
